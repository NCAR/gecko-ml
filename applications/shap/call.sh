...
python gecko_shap.py ../../config/toluene_agg_rnn.yml -s /glade/work/schreck/repos/GECKO_OPT/clean/gecko-ml/applications/shap/toluene/gru -m /glade/work/schreck/repos/GECKO_OPT/gecko-ml/echo/toluene/6/best.pt --workers 10

python gecko_shap.py ../../config/apin_O3_agg_rnn.yml -s /glade/work/schreck/repos/GECKO_OPT/clean/gecko-ml/applications/shap/apin/gru -m /glade/work/schreck/repos/GECKO_OPT/gecko-ml/echo/apin/7/best.pt --workers 10

python gecko_shap.py ../../config/dodecane_agg_rnn.yml -s /glade/work/schreck/repos/GECKO_OPT/clean/gecko-ml/applications/shap/dodecane/gru -m /glade/work/schreck/repos/GECKO_OPT/gecko-ml/echo/dodecane/3/best.pt --workers 10